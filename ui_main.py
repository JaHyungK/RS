...
"}")
        ...
        # 데이터 엔진 윈도우 #
        self.Rs_widget = RsWindow()
        self.Rs_widget.setObjectName(u"DataEngine_widget")

        self.verticalLayout_10 = QVBoxLayout()
        self.verticalLayout_10.setObjectName(u"verticalLayout_10")

        self.label_6 = QLabel(self.Rs_widget)
        ...
        self.label = QLabel(self.Rs_widget)
        ...
        self.label_7 = QLabel(self.Rs_widget)
...
"")
        ...
        self.stackedWidget.addWidget(self.Rs_widget)
